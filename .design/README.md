...
| 4 | [`vyra-domain.md`](vyra-domain.md) | *What are the Bounded Contexts, Entities, Value Objects, Repositories, and Specifications?* | Anyone designing a module or aggregate — the DDD model layered over the graph spine and architecture |
