...
import { CalendarTask, CALENDAR_YEAR_START, WEEK_MS, TOTAL_WEEKS, weekNumberOf } from './calendar';
        ...
        return (
            <div className="h-screen bg-zinc-950 flex items-center justify-center">
                <div className="flex items-center gap-3 text-zinc-500">
                    ...
                    <span className="text-sm">Loading 52-week matrix…</span>
                </div>
            </div>
        );
    }
                ...
                <div className="flex items-center justify-between px-6 py-5">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-zinc-500 leading-tight">52-Week Compliance Calendar · Matrix (v2)</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-5">
                        ...
                        <Link href="/calendar" className="text-sm text-zinc-400 hover:text-zinc-100 transition-colors">
                            Week-row view (v1)
                        </Link>
